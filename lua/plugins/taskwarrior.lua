return {
  ...
  config = function()
    ...
    vim.api.nvim_set_keymap(
      ...
      { desc = "TaskWarrior Update Current", noremap = true, silent = true }
    )
    vim.api.nvim_set_keymap(
      "n",
      "<leader>ts",
      "<cmd>TWSyncTasks<cr>",
      { desc = "TaskWarrior Sync Tasks", noremap = true, silent = true }
    )
    vim.api.nvim_set_keymap(
      "n",
      "<c-space>",
      "<cmd>TWToggle<cr>",
      { desc = "TaskWarrior Toggle Window", silent = true }
    )
